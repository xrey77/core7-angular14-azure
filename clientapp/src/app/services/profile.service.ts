...
export class ProfileService {
  ...
  public getUserbyId(id: string, token: any): Observable<any> {
    ...
    return this.httpclient.get("http://localhost:5073/api/getuserbyid/" + id, options)
  ...
  public ActivateMFA(id: string, enabled: ActivateMfa, token: any) {
    ...
    return this.httpclient.put("http://localhost:5073/api/enablemfa/" + id, enabled, options)
    .pipe(catchError(this.handleError));
  }
  ...
  public sendProfileRequest(id: string, userdtls: Userprofile, token: any): Observable<any> {
    ...
    return this.httpclient.post<Userprofile>("http://localhost:5073/api/updateprofile/" + id,userdtls, options)
    .pipe(catchError(this.handleError));
  }
}
